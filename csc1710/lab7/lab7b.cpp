...
int main()
{
   ...
   cin >> x;
   power = x;
   //asking the user to give the value for n
   cout<< "What is the largest value that n can be? ";
   cin >> n;
   ...
   //identify
   //for loop that asks the user for the n value, which is basically where 
   //the program stops the calculations
   for(i = 1; i<=n; i++)
   {
